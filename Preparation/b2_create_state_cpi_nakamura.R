# Purpose: Create time series of US cpommuting zones inflation data
# Inputs: 
...
# save  
write_csv(cpi, "../SocialInflationExpectation/_intermediate/cpi_cz2000-timeseries_nakamura.csv")
