...
write_csv(spb, paste("../SocialInflationExpectation/_intermediate/SPB_",l,".csv", sep = ""))
...
write_csv(ppb, paste("../SocialInflationExpectation/_intermediate/PPB_",l,".csv", sep = ""))
