...
dat_cpi <- read_csv(paste("../code/_intermediate/cpi_",l,".csv", sep = ""))
...
dat_inflexp <- read_csv(paste("../code/_intermediate/inflexp_",l,"_",s,".csv", sep = ""))

# Read in SCI-weighted inflation (Social Proximity to Inflation)
# Built in a1_create_SPI_PPI.R
SPI <- read_csv(paste("../code/_intermediate/SPI_",c,"_",l,".csv",sep="")) 

# Read in distance-weighted inflation (Physical Proximity to Inflation)
# Built in a1_county_data_collect.R
# dist_weighted_inflation <- read_csv("../code/_intermediate/dist_weighted_inflation.csv")
PPI <- read_csv(paste("../code/_intermediate/PPI_",c,"_",l,".csv",sep="")) 
...
writeLines(capture.output(stargazer(fe1,tefe1,fe2,tefe2,fe3,tefe3,fe4,tefe4,title="Fixed Effects Regression Results",align=TRUE, label = "tab:regfe", model.names = TRUE)), paste("../code/_output/FE_",l,".tex",sep = ""))
...
# save stargazer output in tex file
writeLines(capture.output(stargazer(po1,tepo1,po2,tepo2,po3,tepo3,po4,tepo4,title="Pooled OLS Regression Results",align=TRUE, label = "tab:regpo", model.names = TRUE)), paste("../code/_output/POLS_",l,".tex",sep = ""))
...
pdf(file = paste("../code/_output/SPI2_",l,".pdf",sep=""), width=6, height=6)
...
pdf(file = paste("../code/_output/PPI2_",l,".pdf",sep=""), width=6, height=6)
...
# save stargazer output in tex file
writeLines(capture.output(stargazer(o1,o12, o2,o22, o3,o32, o4,o42, title="Regression Results Split by Outwardness",align=TRUE, label = "tab:regout", model.names = TRUE)), paste("../code/_output/Outwardness_",l,".tex",sep = ""))
...
# save stargazer output in tex file
writeLines(capture.output(stargazer(i1,i12, i2,i22, i3,i32, i4,i42, title="Regression Results Split by Inflation Expectations",align=TRUE, label = "tab:regexp", model.names = TRUE)), paste("../code/_output/InflexpSplit_",l,".tex",sep = ""))
