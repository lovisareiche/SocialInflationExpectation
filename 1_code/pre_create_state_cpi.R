...
dir.geo <- "../code/_input/cz00_eqv_v1.csv"

# Regional CPI data
# https://data.bls.gov/cgi-bin/dsrv
dir.e_n_c <- "../code/_input/East North Central.xlsx"
dir.e_s_c <- "../code/_input/East South Central.xlsx"
dir.m_a <- "../code/_input/Middle Atlantic.xlsx"
dir.m <- "../code/_input/Mountain.xlsx"
dir.n_e <- "../code/_input/New England.xlsx"
dir.p <- "../code/_input/Pacific.xlsx"
dir.s_a <- "../code/_input/South Atlantic.xlsx"
dir.w_n_c <- "../code/_input/West North Central.xlsx"
dir.w_s_c <- "../code/_input/West North Central.xlsx"
...
reg_states <- read_xlsx("../code/_input/Regions to states.xlsx") 
...
write_csv(cpi, "../code/_intermediate/cpi_cz2000-timeseries.csv")
